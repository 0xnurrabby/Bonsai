...
// Using your provided contract as the recipient by default.
// You can change this to a separate treasury address later.
...
export default function App() {
  ...
  async function sendGameTx(intent: "plant" | "water" | "revive" | "graft") {
    ...
    if (!isLikelyAddress(RECIPIENT)) {
      toast.show("Recipient address invalid. Sending disabled.");
      return false;
    }
  ...
  async function sendTip() {
    ...
    if (!isLikelyAddress(RECIPIENT)) return toast.show("Recipient not set. Sending disabled.");
    ...
    try {
      ...
      const data = encodeUsdcTransfer(RECIPIENT, amountBaseUnits);
